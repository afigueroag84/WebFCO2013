...
<head>
  ...
  <meta name="Description" content="Sitio de Fundación Comunitaria Oaxaca A.C. Aqui encontrarás información de nosotros y 
  de las alianzas que hemos logrado para ayudar mejorar la vida de las personas y del medio ambiente las comunidades en Oaxaca" />
          ...
          <nav> 
            <div class="menugrande">
              <ul>
                ...
                <li><a href="fondos.php"><u>Fondos</u></a></li>
...
<?php include("modulos/fondos/fondosredux.php") ?>

<?php include("modulos/boletines.php") ?>

<?php include("modulos/convocatorias.php") ?>
