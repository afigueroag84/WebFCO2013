...
<head>
  ...
  cómo puedes localizar nuestras oficinas o comunicarte con nosotros." />
          ...
          <nav> 
            <div class="menugrande">
              <ul>
                ...
                <li><a href="contacto.php"><u>Contacto</u></a></li>
              </ul>
            </div>
            <div class="top-bar">
              <ul class="title-area">
...
<?php include("modulos/contacto/contactoredux.php") ?>
